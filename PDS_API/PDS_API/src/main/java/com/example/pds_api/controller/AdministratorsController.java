...
//    获取分销商信息根据分销商id
    @GetMapping("/getdistributorinfobyid")
    public Result getDistributorInfoById(@RequestParam("distributorId")Integer distributorId) {
        Distributor distributorInfoById = administratorsService.getDistributorInfoById(distributorId);
        return Result.success("分销商信息",distributorInfoById);
    }

//    编辑分销商信息根据分销商id
    @PostMapping("/updatedistributorinfo")
    public Result updateDistributorInfo(@RequestBody DistributorDTO distributorDTO) {
        Integer integer = administratorsService.updateDistributorInfo(distributorDTO);
        return Result.success("修改成功",integer);
    }

//    新增分销商
    @PostMapping("/adddistributorinfo")
    public Result addDistributorInfo(@RequestBody DistributorDTO distributorDTO) {
        Integer integer = administratorsService.addDistributorInfo(distributorDTO);
        if (integer == 1){
            return Result.success("新增成功",integer);
        }
...
//    删除分销商信息根据分销商id
    @GetMapping("/deletedistributorinfobyid")
    public Result deleteDistributorInfoById(@RequestParam("distributorId")Integer distributorId) {
        Integer integer = administratorsService.deleteDistributorInfoById(distributorId);
        if (integer == 1){
